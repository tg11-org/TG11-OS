...
path = '/mnt/u/Projects/TG11-OS/kernel/terminal.c'

with open(path, 'rb') as f:
    raw = f.read()

# Work in LF-normalised form for matching, restore CRLF on write if needed
crlf = b'\r\n' in raw
...
if OLD in content:
    ...
    if idx >= 0:
        print('Found marker at', idx, '- showing raw context:')
